...
const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { id: 'daily', label: 'Daily P&L', icon: <DailyIcon />, priority: true },
      { id: 'stock', label: 'Stock', icon: <AgentsIcon />, priority: true },
      { id: 'tasks', label: 'Tasks', icon: <TasksIcon />, priority: true },
      { id: 'activity', label: 'Activity', icon: <ActivityIcon />, priority: true },
      { id: 'cron', label: 'Scheduled', icon: <CronIcon />, priority: true },
